...
transformed parameters{
  ...
  mae = mean_asymmetric_error(len_data, log_rpt_loss, mu_rpt_loss

  // upside is the squared error
  , auto upside = (vector[len_data] y_pred, vector[len_data] y_true) -> real {(y_pred - y_true)^2;};

  // downside is the absolute error
  , auto downside = (vector[len_data] y_pred, vector[len_data] y_true) -> real {fabs(y_pred - y_true);};
  );
  }
