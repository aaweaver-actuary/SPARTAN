...
functions{
  // function that takes a vector `ata` with development parameters and
  // returns a vector `atu` of the same size by
  // 1. taking the log of each element
  // 2. setting the final value of atu to ata's final value
  // 3. setting the 2nd to final value of atu to the sum of the 2nd to final value of ata and the final value of atu
  // 4. setting the 3rd to final value of atu to the sum of the 3rd to final value of ata and the 2nd to final value of atu
  // 5. continuing this process until the first value of atu is set
  // 6. taking the exponential of each element of atu
  // 7. returning atu
  /**
    * @title Calculate Age-to-ultimate
  ...
  /**
    ...
    * @raise error if number of origin periods is not equal to number of rows in loss matrix
    * @raise error if number of development periods is not equal to number of columns in loss matrix
